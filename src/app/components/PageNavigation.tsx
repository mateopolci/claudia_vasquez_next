            ...
            <nav className="border-t border-gray-200 flex items-center justify-between sm:px-0">
                <div className="-mt-px w-0 flex-1 flex justify-start mx-2 sm:mx-8">
                    {currentPage > 1 && (
                        ...
                        >
                            <svg
                                className="mr-3 h-5 w-5 text-black-400"
                    ...
                    {pageNumbers.map((pageNumber, index) => {
                        if (pageNumber === -1) {
                            return (
                                <span
                                    key={`ellipsis-${index}`}
                                    className="border-transparent text-black-500 border-t-2 pt-4 px-2 sm:px-4 inline-flex items-center text-sm font-medium"
                                >
                                    ...
                                </span>
                            );
